...
サービスの立ち上げや、グロースにおいてPdMをやってみたいです。
もともとプロダクトを作りたくてエンジニアになったので、そろそろサービス
さらにML使ったプロダクトならめちゃくちゃ楽しいだろうなと思います。
